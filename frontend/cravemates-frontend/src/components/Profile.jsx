...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([axios.get(`/profile/${username}/`), axios.get(`/feed/`)])
      ...
      <Box
        ...
        <Box sx={{ textAlign: "center", marginBottom: 4 }}>
          ...
          <Typography
            ...
            {profile?.bio ||
              "Welcome to CraveMates. Click 'Edit Profile' to update bio and profile picture."}
          </Typography>
          <Button
            variant='outlined'
            sx={{ marginTop: 2 }}
        ...
        <Box
          ...
          <Button
            variant='text'
            onClick={() => handleNavigation(`/groups/${username}`)}>
            Groups
          </Button>
          <Button
            variant='text'
            onClick={() => handleNavigation(`/likes/${username}`)}>
            Likes
          </Button>
          <Button
            variant='text'
            onClick={() => handleNavigation(`/channels/${username}`)}>
            Channels
          </Button>
        </Box>
              ...
              <Paper
                ...
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <Avatar
                    ...
                    src={
                      post.user.profile_picture || "/static/default_avatar.jpg"
                    }
